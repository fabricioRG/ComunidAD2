...
class SesionServiceMock {
  ...
  usuarioEsAdministradorDeComunidad = jasmine.createSpy(
    'sesionService.usuarioEsAdministradorDeComunidad'
  );
}
...
describe('CreateComunityComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        MatRadioModule,
        MatInputModule,
      ], //Los imports que necesito en la prueba
  ...
  it('buscar cursos encontrando cursos', () => {
    ...
    //Arrange
    var cursos: any = [
      { codigoDeCurso: '0', nombre: 'SIN CURSO', noDeSemestre: 0 },
      { codigoDeCurso: '028', nombre: 'Social Humanistica', noDeSemestre: 1 },
      {
        codigoDeCurso: '119',
        nombre: 'Tecnica Complementaria',
        noDeSemestre: 1,
      },
      { codigoDeCurso: '146', nombre: 'Fisica 1', noDeSemestre: 3 },
      { codigoDeCurso: '169', nombre: 'Matematica Basica 1', noDeSemestre: 1 },
      { codigoDeCurso: '170', nombre: 'Matematica basica 2', noDeSemestre: 2 },
      { codigoDeCurso: '177', nombre: 'Deportes 1', noDeSemestre: 1 },
      {
        codigoDeCurso: '2666',
        nombre: 'Orientacion y Liderazgo',
        noDeSemestre: 1,
      },
    ];
  ...
  it('Generar Asignacion Comunidad', () => {
    ...
    var result: string | undefined = component.generarAsignacionDeComunidad(
      community,
      registroAcademico
    ).idComunityAssign?.registroAcademico;
    //Assert
    if (result) {
      expect(expResult).toEqual(result);
    }
