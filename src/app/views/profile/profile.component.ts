...
export class ProfileComponent implements OnInit {
  ...
  constructor(private dataService: DataService,public validacionURL: LoginService, private constantesService : ConstantesService,private _modalService: NgbModal,private _modalPropio: ModalService) {
